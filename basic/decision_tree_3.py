...
def display(n_estimators):
    forest = RandomForestClassifier(criterion='entropy', n_estimators=n_estimators, random_state=1, n_jobs=2)
    ...
    fig = plt.figure(1)
    fig.canvas.set_window_title('n_estimators: {n_estimators}'.format(n_estimators=n_estimators))
    plt.show()
